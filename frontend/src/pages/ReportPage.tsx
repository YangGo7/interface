...
export function ReportPage() {
    ...
    const { reportUrl } = location.state || {}; // Access the direct URL
    ...
    return (
        <div className="h-screen flex flex-col bg-gray-50 overflow-hidden">
            ...
            <div className="flex-1 w-full relative bg-gray-200">
                ...
                />
                {/* Loading fallback hidden behind iframe if it loads, or visible if it's slow?
            Actually browser handles white flash. */}
            </div>
        </div>
    );
}
