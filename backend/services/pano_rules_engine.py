...
class RulesEngine:
    def __init__(self, img_width: int, img_height: int, k_implant: float = 0.8):
        self.W = img_width
        self.H = img_height
    ...
    def _process_arch_with_metrics(self, objects: List[Dict[str, Any]], metrics: Dict[str, Any], is_upper: bool) -> Dict[str, Any]:
        ...
        # D. Assign Objects
        assigned_slots = self._assign_objects(slots_grid, objects, metrics)
    ...
    def _assign_objects(self, slots: Dict[str, Dict], objects: List[Dict[str, Any]], metrics: Dict[str, Any]) -> Dict[str, Dict]:
        dx = metrics['dx']
        ...
        for obj in objects:
            if obj['type'] == 'natural' and obj.get('label_hint'):
        ...
        unassigned_objs = [o for o in objects if o['type'] != 'natural' or not o.get('label_hint')]
        # Also include naturals that didn't match any slot (e.g. invalid label)
        unassigned_objs += [o for o in objects if o['type'] == 'natural' and str(o.get('label_hint')) not in slots]
